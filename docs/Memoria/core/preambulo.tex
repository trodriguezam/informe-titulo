...
% Capítulos del Índice General en MAYÚSCULAS (coincide con el template docx).
% Subsecciones y sub-subsecciones mantienen su capitalización natural.
\makeatletter
\let\old@l@chapter\l@chapter
\renewcommand{\l@chapter}[2]{\old@l@chapter{\protect\MakeUppercase{#1}}{#2}}
\makeatother
