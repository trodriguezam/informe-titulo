...
\begin{enumerate}
  ...
  \item \textbf{Cobertura de las estructuras del procedimiento:} el sistema debe producir las estructuras que delimitan el punto de incisión de la cricotiroidotomía, esto es, el cartílago tiroides, el cricoides, el hioides, la laringe y la tráquea. Sin ellas el fantoma pierde su propósito, con independencia de cuántas otras estructuras logre segmentar.
...
La elección de la herramienta de segmentación no se dio por sentada, sino que se resolvió mediante una comparación entre las tres alternativas consideradas. El criterio de autonomía enunciado más arriba opera como filtro previo: una herramienta que no lo satisface queda descartada, con independencia de su desempeño en cualquier otra dimensión. Sobre las que lo satisfacen, la comparación se estructuró en torno a los siguientes criterios, cuya definición formal se entrega en el Capítulo~\ref{ch:diseno-del-producto} y cuyos resultados se discuten en el Capítulo~\ref{ch:resultados}:

\begin{enumerate}
  \item \textbf{Cobertura anatómica:} cuántas de las estructuras de la referencia logra segmentar el modelo con contenido real.
  \item \textbf{Concordancia con la referencia clínica:} las estructuras segmentadas deben alcanzar un coeficiente de Dice promedio igual o superior a 0,85 respecto de la segmentación de referencia validada por el especialista. Este criterio mide reproducibilidad frente al material clínico disponible, y no precisión frente a una anotación independiente, distinción que se desarrolla en el Capítulo~\ref{ch:resultados}.
