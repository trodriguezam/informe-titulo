...
\begin{enumerate}
  ...
  \item \textbf{Concordancia con la referencia:} cuánto se superpone cada estructura predicha con su contraparte en la segmentación de referencia, medida mediante el coeficiente de Dice y la intersección sobre la unión (IoU).
