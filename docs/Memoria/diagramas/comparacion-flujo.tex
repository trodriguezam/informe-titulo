...
\node[botbox]                     (mseg)  at (5.0, 2.7) {Segmentación manual\\\scriptsize(según la literatura revisada)};
...
\node[font=\scriptsize\itshape, text=botDraw,  below=0.2cm of mseg] (mtime) {$\approx$ 2{,}7\,h};
